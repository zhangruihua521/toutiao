      ...
      <el-header class="my-header">
        ...
        <el-dropdown style="float:right">
          <span class="el-dropdown-link" >
              <img :src="avator" alt="" style="vertical-align:middle" width="30" height="30">
           <span style="vertical-align:middle;padding-left:5px">{{name}}</span>
...
.home-container {
  ...
  .my-aside {
    ...
    .logo{
      ...
      height: 60px;
      //背景图定位/背景图尺寸
      background: #0333 url('../../assets/images/logo_admin.png') no-repeat center/140px auto;
    }
    .close{
